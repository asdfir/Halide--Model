...
data = pd.read_csv(r"C:\Users\小华\Desktop\luhuawuzong2.1.csv")
...
# score_tr= []
# score_te=[]
# C_range = np.arange(1,201,1)
# for i in C_range:
rf = RandomForestRegressor(n_estimators=5,max_depth=7,random_state=42,min_samples_split =2).fit(x_train,y_train)
...
# selected_features = list(x.columns[rfe.support_])#查看所选择的特征
