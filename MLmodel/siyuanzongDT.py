...
#决策树模型
dt_reg = DecisionTreeRegressor(max_depth=4,random_state = 452,min_samples_split =9).fit(x_train,y_train)
...
#递归消除
# model = DecisionTreeRegressor(max_depth=4,random_state = 452,min_samples_split =9)
# feature_counts = []
# scores = []
# scores2 = []
